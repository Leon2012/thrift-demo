...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "   funCall(i64 callTime, string funcCode,  paramMap)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := demo.NewRpcServiceClientFactory(trans, protocolFactory)
  ...
  case "funCall":
    ...
    containerStruct2 := demo.NewFunCallArgs()
